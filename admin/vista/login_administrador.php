...
<head>
    ...
    <link href="../../css/login_administrador.css" rel="stylesheet" type="text/css"/>
...
<body>
    ...
    <form id="loginForm" method="POST" onsubmit="return validarCamposObligatoriosLogin()" action="../../controladores/loginAdmin.php">
    ...
    <div id="link">
    <br> <a class="creacion" href="crear_admin.html">CREAR CUENTA ADMIN</a>
    </div>
